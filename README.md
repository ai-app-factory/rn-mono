# rn-mono
React Native mono-repo managed by pnpm and nx
...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/S6Ltyt8MZf)
...
```sh
npx nx serve pnpm-expo-rn-mono
```

To create a production bundle:

```sh
npx nx build pnpm-expo-rn-mono
```

To see all available targets to run for a project, run:

```sh
npx nx show project pnpm-expo-rn-mono
```
