          ...
          <View style={styles.section}>
            <View style={styles.shadowBox}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  Linking.openURL('https://cloud.nx.app/connect/GWwYgYxTlX');
                }}
              >
                <Text
                  style={[
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx test PnpmExpoRnMono
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint PnpmExpoRnMono
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p PnpmExpoRnMono -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project PnpmExpoRnMono
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
